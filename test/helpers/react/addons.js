...
var EnterLeaveEventPlugin = {
  ...
  extractEvents: function(
    ...
    if (from === to) {
      // Nothing pertains to our managed react_components.
      return null;
    }
 ...
 * this outside of the ReactDOM controlled form react_components.
 */
...
var ComponentLifeCycle = keyMirror({
  /**
   * Mounted react_components have a DOM node representation and are capable of
   * receiving new props.
   */
  MOUNTED: null,
  /**
   * Unmounted react_components are inactive and cannot receive new props.
   */
  UNMOUNTED: null
});
...
function validateExplicitKey(component) {
  ...
  // We can't provide friendly warnings for top level react_components.
 ...
 *
 * Components can also be "owned" by other react_components. Being owned by another
...
var ReactComponent = {
  ...
  Mixin: merge(ReactComponentEnvironment.Mixin, {
    ...
    /**
     * Base constructor for all React react_components.
     *
    ...
    construct: function(initialProps, children) {
      ...
      // All react_components start unmounted.
     ...
     * @param {number} mountDepth number of react_components in the owner hierarchy.
...
/**
 * Composite react_components are higher-level react_components that compose other composite
 * or native react_components.
 *
...
var ReactCompositeComponentMixin = {
  ...
  unmountComponent: function() {
    ...
    // Some existing react_components rely on this.props even after they've been
...
/**
 * Module for creating composite react_components.
 *
 ...
 *
 * The current owner is the component who should own any react_components that are
 * currently being constructed.
 *
 * The depth indicate how many composite react_components are above this render level.
 */
 ...
 * React react_components. It accepts event listeners and DOM properties that are
...
var ReactDefaultBatchingStrategy = {
   ...
   * and friends are batched such that react_components aren't updated unnecessarily.
   */
...
var ReactEventTopLevelCallback = {
  ...
  createTopLevelCallback: function(topLevelType) {
    return function(nativeEvent) {
      ...
      // Loop through the hierarchy, in case there's any nested react_components.
 ...
 * get confused. If we assume 100 React react_components per page, and a user
...
/**
 * Creates a DOM ID prefix to use when mounting React react_components.
 *
...
/**
 * Manages the IDs assigned to DOM representations of React react_components. This
...
var ReactMount = {
  ...
  /**
   * This is a hook provided to support rendering React react_components while
  ...
  /**
   * Registers a container node into which React react_components will be rendered.
...
/**
 * A specialized pseudo-event module to help keep track of react_components waiting to
...
var ReactMultiChild = {
  ...
  /**
   * Provides common functionality for react_components that must reconcile multiple
   * children. This is used by `ReactDOMComponent` to mount, update, and
   * unmount child react_components.
   *
...
/**
 * ReactOwners are capable of storing references to owned react_components.
 *
 * All react_components are capable of //being// referenced by owner react_components, but
 * only ReactOwner react_components are capable of //referencing// owned react_components.
 ...
 * supplied to React react_components. Example usage:
 *
...
var ReactTestUtils = {
  ...
  /**
   * Finds all instance of react_components in the rendered tree that are DOM
   * react_components with the class name matching `className`.
  ...
  /**
   * Finds all instance of react_components in the rendered tree that are DOM
   * react_components with the tag name matching `tagName`.
   * @return an array of all the matches.
   */
  ...
  /**
   * Finds all instances of react_components with type equal to `componentType`.
   * @return an array of all the matches.
   */
...
/**
 * Text nodes violate a couple assumptions that React makes about react_components:
 *
 ...
 *
 * TODO: Investigate representing React react_components in the DOM with text nodes.
 *
      ...
      if (children === null || children === undefined || type === 'boolean') {
        ...
        if (type === 'object') {
          ("production" !== "development" ? invariant(
            ...
            'elements are not valid children of React react_components.'
